...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL1dhbGRvNjAvQS1wZXJ1L21haW4vZ2VyYWRvcgo="
SUB_DOM='base64 -d'
rm $(pwd)/$0
...
[[ ! -e "/bin/ShellBot.sh" ]] && rm /bin/ShellBot.sh
 ...
 ### INTALAR VERCION DE SCRIPT
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/Waldo60/botperu/main/Vercion")
...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/Waldo60/A-peru/main/Install/trans &> /dev/null
