...
echo 'clear' >> .bashrc
echo 'echo ""' >> .bashrc
echo 'echo -e "\t\033[91m __     ______  ____        __  __  ___ " '>> .bashrc
echo 'echo -e "\t\033[91m \ \   / /  _ \/ ___|      | |  | |  -  |" '>> .bashrc
echo 'echo -e "\t\033[91m  \ \ / /| |_) \___ \ _____| |/\| | | | |" '>> .bashrc
echo 'echo -e "\t\033[91m   \ V / |  __/ ___) |_____|  /\  | |-| |" '>> .bashrc
echo 'echo -e "\t\033[91m    \_/  |_|   |____/      |_/  \_|\____/" '>> .bashrc
echo 'echo "" '>> .bashrc
...
msg -bar2
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ MOD By @Woli7 ❌\033[1;33m ]"
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "Code de KEY Invalido!") ]]; then
   msg -bar2
   msg -verd "$(source trans -b es:${id} " Ficheros Copiados"|sed -e 's/[^a-z -]//ig'): \e[97m[\e[93mVPS-MX #MOD by @Woli01\e[97m]"
